...
console.log(15 % 2); // Modlus: gives you the remainder of the division

console.log(2 ** 3); // Exponentiation: raises the first number to the power of the second

let a = Number(prompt(Give me a number:"));
let b = 3;
console.log(a + b); // You can use math operators on variables too.

console.log(a + b * 2); Javascript follows the order of operations
