...
console.log(5 == 5); // Loose equality: checks if the values are equal, but does not check the type
console.log(0 !== false); // Strict inequality: checks if the values are not equal or not of the same
